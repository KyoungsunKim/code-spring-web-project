    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
            	...
            	<button type="button" id="addReplyBtn" class="btn btn-primary btn-xs pull-right">New Reply</button>
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
            	<ul class="chat">
            		...
            		<!-- <li class="left clearfix" data-rno='12'>
            			<div>
            				<div class="header">
            					...
            					<small class="pull-right text-muted">2019-01-12 10:20</small>
            				</div>
            				<p>Good job!</p>
            			</div>
            		</li> -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
           		<div class="form-group">
           			<label>Reply</label> <input class="form-control" name="reply" value='<c:out value="${board.title}"/>'>
           		</div>
           		<div class="form-group">
           			<label>Replyer</label> <input class="form-control" name="replyer" value='<c:out value="${board.title}"/>'>
           		</div>
           		<div class="form-group">
